 <div class="content-wrapper">
    ...
    <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                  <h4 class="card-title">Xabarni tahrirlash</h4>
                  <form class="forms-sample" method="post" autocomplete="off" action="{base_url}manage/news/update/<?=$news['news_id']?>" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="title">Sarlavha</label>
                      <input type="text" class="form-control" id="title" name="title" placeholder="Xabar sarlavhasi..." value="<?=$news['title']?>" required="">
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="quil-fake-data" name="content" style="display: none;"><?=$news['content']?></textarea>
  ...
  <script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function(event) { 
      ...
      ?>
      var categories = [];
      var as=$(json).filter(function (i,n){return n.language === '<?=$news['language'];?>'});
      $.each( as, function( k, v ) {
        item = {}
        item["id"] = v.category_id;
        item["text"] = v.category_name;
        if (v.category_id == <?=$news['category_id'];?>) {
          item["selected"] = true;
        }
