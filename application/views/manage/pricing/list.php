        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Narxlar jadvali</h4>
                  <div class="row">
                  <?
                    $limit = 36;
                    ...
                    if ($this->input->get('q') != '') {
                      $this->db->like('price', $this->input->get('q'));
                      $this->db->or_like('name', $this->input->get('q'));
                      $this->db->or_like('subtitle', $this->input->get('q'));
          ...
          <?
           if ($this->input->get('q') != '') {
            ...
            $allcount = $this->db->count_all_results('pricing');
            $queries = $this->input->get(); unset($queries['page']);

            if (count($queries) > 0) {
              $config['base_url'] = base_url('manage/pricing/list?'.http_build_query($queries));
            }else{
              $config['base_url'] = base_url('manage/pricing/list');
            }
